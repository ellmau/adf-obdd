...
for i in /home/ellmau/repo/adf-obdd/res/adf-instances/instances/*.adf; do
    ...
    ({ time timeout 10s /home/ellmau/repo/adf-obdd/target/release/adf_bdd  --stmrew -q --lib hybrid $i } >> output.txt 2>&1 )
    ({ time timeout 10s /home/ellmau/repo/adf-obdd/target/release/adf_bdd  --stmrew2 -q --lib hybrid $i } >> output.txt 2>&1 )
